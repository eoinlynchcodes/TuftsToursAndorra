...
<body>
  ...
  <nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;"
    ...
    <div class="w3-container">
      <h3 class="w3-padding-64"><b>Tufts <br> Adventure <br> Tours</b></h3>
    </div>
    <div class="w3-bar-block">
      ...
      <a href="#upcomingTours" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Upcoming Tours</a>
      <a href="#sveinsStory" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Svein's Story</a>
      <a href="#bikesForRental" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Bikes for Rent</a>
      <a href="#guides" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Our Guides</a>
      <a href="#proconsultation" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-yellow">Professional
        Consultation</a>
    </div>
  </nav>
  ...
  <header class="w3-container w3-top w3-hide-large w3-red w3-xlarge w3-padding">
    ...
    <span>Tufts Adventure Tours</span>
  </header>
  ...
  <div class="imageBox">
    <img class="HomeImage" src="images/SveinBikeMountain.jpeg" alt="Gravel Cycling">
    <!-- <h1 class="imageText">Gravel Bike Tours in Andorra by Svein Tuft</h1> -->
  </div>
  ...
  <div class="w3-main" style="margin-left:340px;margin-right:40px">
    ...
    <!-- Home / Tufts Adventure Tours -->
    <div class="w3-container" id="about" style="margin-top:75px">
      <h1 class="w3-xxxlarge w3-text-red"><b>Gravel Bike Touring in Andorra</b></h1>
      <hr style="width:50px;border:5px solid #333" class="w3-round">
      <p><b>Come and explore Andorra and its surrounding areas by Gravel Bike. Guides with local knowledge and unique
    ...
    <!-- <div class="w3-container" id="services" style="margin-top:75px">
      ...
      <hr style="width:50px;border:5px solid #333" class="w3-round">
      <p>Andorra and neighboring France and Spain in the Pyrenees are renowned for many things. For hiking, skiing, it's
        ...
        The type of bike ride possible here:
        “If starting from Andorra La vella, make your way up to La Massana. From there climb up to the CG4 direction
        Pal. Take the CG4 all the way to Port de Cabus. From La Vella it’s roughly 1300 m of climbing. At the summit the
        road turns to Gravel and becomes the Carretera de Tor. Big descent passing Tor and Noris and finally coming back
        on pavement in Alins. From there take a left on the L-510 down the valley to the L-504 junction, taking a right
        on L-504 heading north to Tavascan. From Tavascan take the Cami de Graus through Quanca. This is a nice gravel
        road and climbing roughly 700 m until the road ends and then turns to single track/trail. There’s some good
        riding and some hiking until the pass at 2100 m. Now you are in France. Some steep technical hiking downhill and
        some great technical descending sections. The route finally washes out on a small D road in the Ossese valley
        and turns into the D38. Descend until you come to the D8f. Take the D8f until the D18 junction and turn right.
        This takes you to the town of Vicdessos. Follow signs to Auzat. From Auzat take the D8 up the Soulcem valley. A
        massive climb awaits. After Soulcem lake the road turns to gravel and you keep climbing deep into the big
        mountains. As the gravel road comes to an end there is a small trail on the left heading up to the Port de Rat.
        From here about an hour of hike and bike to the 2500m pass. Then the trail drops steeply down into Andorra
        Arcalis ski area. The road is gravel at 1st and then become paved as you get closer to the ski station. Take the
        CS-380 until Ordino and now you descend all the way back to La vella. The route could be done in one very
        massive day but I recommend taking 2 days to really enjoy it.”</p>
    </div> -->
    ...
    <div class="w3-container" id="location" style="margin-top:75px">
      ...
      <p>
        ...
        Mountains between Girona and Andorra.<br><br>
      </p>

      <iframe width="800" height="500" src="https://www.youtube.com/embed/aKTC8yFddb4" frameborder="0"
        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>

    <!-- HERE WE ADD ABOUT THE BIKES!!! -->
    ...
    <div class="w3-container" id="upcomingTours" style="margin-top:75px">
      <h1 class="w3-xxxlarge w3-text-red"><b>Upcoming Tours</b></h1>
      <hr style="width:50px;border:5px solid #333" class="w3-round">
      <p> Come join us in the high Garrotxa North of Girona for 6 days of gravel specific training. This will be the 1st
        edition of spring training camps with Tufts adventure Tours. The terrain is wild and difficult each day is
        guaranteed to be epic.<br><br>
        ...
        There will be 3 guides and 3 different levels to help everyone achieve their goals.<br><br>
        ...
        adventure racer and head guide David Rovira how to tackle multi day adventure races.<br><br>
    ...
    <div class="w3-row-padding">
      <div class="w3-half w3-margin-bottom">
        <ul class="w3-ul w3-light-grey w3-center">
          <li class="w3-green w3-xlarge w3-padding-32">30 March - 4 April 2020</li>
          <li class="w3-padding-16">5 day training camp on gravel roads</li>
          <li class="w3-padding-16">Location: Garrotxa Mountains, Catalonia, Spain</li>
          <li class="w3-padding-16">Gravel Bike Hire Available</li>
          <li class="w3-padding-16">Based out of a beautiful, old, Catalan Farmhouse</li>
          <li class="w3-padding-16">Talks on Training, Nutrition & much more</li>
          <li class="w3-padding-16">Chef, Soigneur & Mechanic on board</li>
          <li class="w3-padding-16">Finish in nearby Girona with a meal.</li>
          <!-- <li class="w3-padding-16">Good deals</li> -->
          <!-- <li class="w3-padding-16">
              <h2>$ 199</h2>
              <span class="w3-opacity">per room</span>
          ...
          <li class="w3-light-grey w3-padding-24">
            <a href="https://www.experienciarural.cat/en/houses/64-serra-del-bosc"><button
                class="w3-button w3-white w3-padding-large w3-hover-black">See Camp House</button></a>
          </li>
        </ul>
      </div>
      ...
      <div class="w3-half">
        <ul class="w3-ul w3-light-grey w3-center">
          <li class="w3-green w3-xlarge w3-padding-32">21 - 27 April 2020</li>
          <li class="w3-padding-16">5 day training camp on gravel roads</li>
          <li class="w3-padding-16">Location: Garrotxa Mountains, Catalonia, Spain</li>
          <li class="w3-padding-16">Gravel Bike Hire Available</li>
          <li class="w3-padding-16">Based out of a beautiful, old, Catalan Farmhouse</li>
          <li class="w3-padding-16">Talks on Training, Nutrition & much more</li>
          <li class="w3-padding-16">Chef, Soigneurs & Mechanic on board</li>
          <li class="w3-padding-16">Finish in nearby Girona with a meal.</li>
          ...
          <li class="w3-light-grey w3-padding-24">
            <a href="https://www.somrurals.com//es/casa-rural/sr-613-girons-613"><button
                class="w3-button w3-white w3-padding-large w3-hover-black">See Camp House</button></a>
          </li>
        </ul>
      </div>
    ...
    <div class="w3-container" id="sveinsStory" style="margin-top:75px">
      <h1 class="w3-xxxlarge w3-text-red"><b>Svein's Story</b></h1>
      <hr style="width:50px;border:5px solid #333" class="w3-round">
      <p><i>
          ...
          <br><br>
          <img src="images/SveinoAndDog.jpeg" alt="Bike, Svein, Dog">
          <br><br>
          ...
          year or next month!"</i><br><br>
        - Svein Tuft, Tufts Adventure Tours Founder.<br><br></p>


      <iframe width="800" height="500" src="https://www.youtube.com/embed/nCKa3x4xXtg" frameborder="0"
        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>

    <div class="w3-container" id="bikesForRental" style="margin-top:75px">
      <h1 class="w3-xxxlarge w3-text-red"><b>Bikes for Rent</b></h1>
      <hr style="width:50px;border:5px solid #333" class="w3-round">
      <img src="images/TheBike.jpg" alt="Gravel Bike">
      <p><br><br>
        ...
        <a href="https://www.scott-sports.com/global/en/products/bike-bikes-road-gravel-cx">Scott</a> and <a
          href="https://www.brodiebicycles.com/">Brodie</a> bikes you will be riding the best quality gravel bikes on
        the
      ...
      <br>
      <div>
        <h3><u>Scott Addict Gravel 20</u></h3>
        <img src="images/scottgraveladdict20.jpg">
        <p>Key Features:</p>
        <ul> 
          <li>Addict Gravel Disc HMF Carbon Frame</li>
          <li>Shimano GRX RX810 Disc 22 Speed</li>
          <li>Syncros RP2.0 Disc Wheels</li>
          <li>Schwalbe G-ONE Allround Tires</li>
        </ul>
        <p>
          <i>"The SCOTT Addict Gravel 20 has been set up to allow you to ride any road, anywhere and in any weather
          conditions. A lightweight HMF Carbon fiber frame, Syncros components, some rugged Schwalbe G-One tires and
          Shimano Hydraulic disc brakes give you a rig that will let you get your adventure on, no matter what. Find
          yourself, get lost."</i> - Scott Bikes.
        </p>
        <a href="https://www.scott-sports.com/us/en/product/scott-addict-gravel-20-bike?article=274775022">Full Specification is available here.</a>
      </div>
      <br>
      <div>
        <h3><u>Brodie Romax Carbon 2020</u></h3>
        <img src="/images/2020+Brodie+Romax+Carbon.jpg">
        <p>Key Features:</p>
        <ul>
          <li>Textreme Carbon Fibre Frame </li>
          <li>Shimano GRX Hydraulic Brakes</li>
          <li>650b and 700c wheel options</li>
        </ul>
        <p>Brodie are a quality Canadian bike brand that we are happy to offer for rent.</p>
        <a href="https://www.brodiebicycles.com/2020-romax-carbon">Full Specification is available here.</a>
      </div>
    ...
    <div class="w3-container" id="guides" style="margin-top:75px">
      <h1 class="w3-xxxlarge w3-text-red"><b>Meet your Guides</b></h1>
      <hr style="width:50px;border:5px solid #333" class="w3-round">
      ...
      <p>
        ...
        moving on to mountaineering and climbing. <br> For over a decade Richard was climbing some of the most iconic
        routes in the Alps and visiting some other climbing meccas around the world (South Africa, USA, Mali, Morocco,
        Thailand, Jordan, Turquey, Greece, etc)<br>
      ...
      <ul>
        <li>Xterra World Champs</li>
        <li>French Winter Triathlon Champs (1st)</li>
        <li> MTB World Cup Germany</li>
        <li>MTB Spanish Champs, Master 40 (1st)</li>
        <li>MTB Ultramarathon Championships Master 40 (1st)</li>
        <li>MTB World Championships Masters (2nd)</li>
      </ul>
      <p>

        Cycled around the world for 3 years (2014-2017), 55.000km, 42 countries that is at present time the biggest and
        most amazing experience I ever did in my lifetime.
        Professional firefighter in my home town I enjoy my life being in the wild, practicing sports, photography,
        travelling and living a healthy lifestyle
        With fleucny in French, Italian, English and German, Richard can show you the most incredible parts of Andorra.
      </p>
      <br>
      <img src="images/guides.jpeg">
      <br>
      <br>
      <h3>David Rovira Roqueta</h3>
      <p>
      ...
      <ul>
        ...
        <li>
          <u>Other races of notes include:</u> Bull of Africa (South Africa), AR world champs New Zealand, 3x
          Ecomotion Brasil,3x EAH Mexico,
          Endurance Quest Finland.
        </li>
      </ul>
      <br>
      <br>
      ...
      <ul>
        ...
        <li>
          Bikepacking and cycling in; New Zealand, Sicily, Dolomites, Colorado trail, Idaho, Pyrenees full traverse 3
          times, Yorkshire, Walles, Australia, California, Franch and italian Alps.
          David has also raced in road cycling, duathlon (podiums in the catalan championship), mountaneering ski
          (podium in
          the catalan championship), orienteering, running races and more.
        </li>
        <li>
          <u>Ski traverses</u> in La Meije (french Alps) Argentina, Vale d’Aosta, Aletschhorn glacier full
          traverse (Switzerland) Sellaronda (Dolomites), Swedish Lapland and Pyrenees.
        </li>
      </ul>
    </div>

    <div class="w3-container" id="proconsultation" style="margin-top:75px">
      <h1 class="w3-xxxlarge w3-text-red"><b>Professional Consultation</b></h1>
      <hr style="width:50px;border:5px solid #333" class="w3-round">

      <img src="images/CanadianChamp.jpeg">
      <p><br>
        ...
        <br><br>
        Feel free to reach out to Svein@tuftsadventuretours.com to discuss how we can work together.<br><br><br>
      </p>
    </div>
    ...
    <!-- <div class="w3-container" id="guides" style="margin-top:75px">
      ...
      <p>
        <h3>Ricard Calmet</h3>
        Richard has always been passionate about outdoors and sport.
        Richard started racing Motocross and Enduro in his early years finishing 3rd in the Spanish Championships before
        moved to mountaineering and climbing later. <br> For over a decade Richard was climbing some of the most iconic
        routes in the Alps and visiting some other climbing meccas around the world (South Africa, USA, Mali, Morocco,
        Thailand, Jordan, Turquey, Greece, etc)<br>
        This is how he discovered his love for travelling and getting to know new places and people.
        After moving onto become an avid mountainbiker and Xterra triathlete with resuls in races such as:
  ...
  <div class="w3-container" id="contact" style="margin-top:75px">
    ...
    <form action="index.php" target="_blank">
      ...
      <button type="submit" class=" submit w3-button w3-block w3-padding-large w3-red w3-margin-bottom">Send Message</button>
    </form>  
  </div>

  <footer>
    <p>
      Contact: Svein@tuftsadventuretours.com
    </p>

    <p><a class="instagramLogoText" href="https://www.instagram.com/tufts_adventure_tours/">Follow us on Instagram</a>
    </p>

    <p>
      &copy; Tufts Adventure Tours Andorra 2020
    </p>
  </footer>
